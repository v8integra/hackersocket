...
-- CreateEnum
CREATE TYPE "JobLevel" AS ENUM ('ENTRY', 'MID', 'SENIOR');

-- CreateEnum
CREATE TYPE "JobStatus" AS ENUM ('DRAFT', 'ACTIVE', 'EXPIRED');
...
-- CreateIndex
CREATE INDEX "JobPosting_level_status_idx" ON "JobPosting"("level", "status");
